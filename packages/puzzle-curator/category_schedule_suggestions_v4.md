...
Existing puzzles: 0 (0 items already used across 0 specs)


Ed 1 — 2026-03-24
  yellow   [team_players:MI:2026] -> Mumbai Indians 2026 Squad: ['Mitchell Santner', 'SA Yadav', 'Deepak Chahar', 'Hardik Pandya']
  green    [country:Australia] -> Players from Australia: ['DJ Thornely', 'MA Starc', 'M Klinger', 'JP Inglis']
  blue     [top_run_scorers] -> IPL Career Run Scorers (3000+ Runs): ['KD Karthik', 'Q de Kock', 'Shubman Gill', 'V Kohli']
  purple   [played_both:CSK:RCB] -> Played for Both CSK & RCB: ['KM Jadhav', 'BB McCullum', 'JA Morkel', 'AF Milne']
  Resampled YELLOW [team_players:MI:2026]:
    was: ['Mitchell Santner', 'SA Yadav', 'Deepak Chahar', 'Hardik Pandya']
    now: ['Danish Malewar', 'Sherfane Rutherford', 'Mohammad Izhar', 'Ashwani Kumar']
  Resampled BLUE [top_run_scorers]:
    was: ['KD Karthik', 'Q de Kock', 'Shubman Gill', 'V Kohli']
    now: ['SS Iyer', 'DA Miller', 'S Dhawan', 'AM Rahane']
  AMBIGUITY CHECK: PASS



  Final categories:
  yellow   [team_players:MI:2026] -> Mumbai Indians 2026 Squad: ['Danish Malewar', 'Sherfane Rutherford', 'Mohammad Izhar', 'Ashwani Kumar']
  green    [country:Australia] -> Players from Australia: ['DJ Thornely', 'MA Starc', 'M Klinger', 'JP Inglis']
  blue     [top_run_scorers] -> IPL Career Run Scorers (3000+ Runs): ['SS Iyer', 'DA Miller', 'S Dhawan', 'AM Rahane']
  purple   [played_both:CSK:RCB] -> Played for Both CSK & RCB: ['KM Jadhav', 'BB McCullum', 'JA Morkel', 'AF Milne']
  Written -> C:\Users\Modern14\git\ipl_games\packages\puzzle-curator\..\..\apps\web\public\puzzles\ipl\2026-03-24.json
...
Ed 8 — 2026-03-31
  ...
  Ed 10 — 2026-04-02
  yellow   [team_players:KKR:2025] -> Kolkata Knight Riders 2025 Squad: ['AD Russell', 'Mayank Markande', 'Ramandeep Singh', 'Anrich Nortje']
  green    [country:South Africa] -> Players from South Africa: ['AB de Villiers', 'MP Breetzke', 'Q de Kock', 'AK Markram']
  blue     [batting_records] -> IPL Batting Record Holders: ['CH Gayle', 'SK Raina', 'V Kohli', 'DA Warner']
  purple   [ranji:Hyderabad] -> Ranji Trophy: Hyderabad: ['S Badrinath', 'A Ashish Reddy', 'VVS Laxman', 'TL Suman']
  Resampled GREEN [country:South Africa]:
    was: ['AB de Villiers', 'MP Breetzke', 'Q de Kock', 'AK Markram']
    now: ['F du Plessis', 'GC Smith', 'HM Amla', 'AC Thomas']
  AMBIGUITY CHECK: PASS

  Final categories:
  yellow   [team_players:KKR:2025] -> Kolkata Knight Riders 2025 Squad: ['AD Russell', 'Mayank Markande', 'Ramandeep Singh', 'Anrich Nortje']
  green    [country:South Africa] -> Players from South Africa: ['F du Plessis', 'GC Smith', 'HM Amla', 'AC Thomas']
  blue     [batting_records] -> IPL Batting Record Holders: ['CH Gayle', 'SK Raina', 'V Kohli', 'DA Warner']
  purple   [ranji:Hyderabad] -> Ranji Trophy: Hyderabad: ['S Badrinath', 'A Ashish Reddy', 'VVS Laxman', 'TL Suman']
  Written -> C:\Users\Modern14\git\ipl_games\packages\puzzle-curator\..\..\apps\web\public\puzzles\ipl\2026-04-02.json

  Ed 11 — 2026-04-03
  yellow   [team_players:CSK:2026] -> Chennai Super Kings 2026 Squad: ['Matt Henry', 'Ayush Mhatre', 'Akeal Hosein', 'Shreyas Gopal']
  green    [team_players:PBKS:2008] -> Punjab Kings 2008 Squad: ['RR Powar', 'SE Marsh', 'JR Hopes', 'TM Srivastava']
  blue     [top_wicket_takers] -> IPL Career Wicket Takers (100+ Wickets): ['UT Yadav', 'AR Patel', 'A Mishra', 'RA Jadeja']
  purple   [longest_serving] -> Longest Serving IPL Players: ['RG Sharma', 'SP Narine', 'S Dhawan', 'AB de Villiers']
  Resampled BLUE [top_wicket_takers]:
    was: ['UT Yadav', 'AR Patel', 'A Mishra', 'RA Jadeja']
    now: ['TA Boult', 'B Kumar', 'Sandeep Sharma', 'R Ashwin']
  Resampled BLUE [top_wicket_takers]:
    was: ['TA Boult', 'B Kumar', 'Sandeep Sharma', 'R Ashwin']
    now: ['JJ Bumrah', 'AR Patel', 'SN Thakur', 'Kuldeep Yadav']
  Resampled PURPLE [longest_serving]:
    was: ['RG Sharma', 'SP Narine', 'S Dhawan', 'AB de Villiers']
    now: ['MS Dhoni', 'DS Kulkarni', 'MK Pandey', 'RG Sharma']
  Resampled PURPLE [longest_serving]:
    was: ['MS Dhoni', 'DS Kulkarni', 'MK Pandey', 'RG Sharma']
    now: ['WP Saha', 'RV Uthappa', 'MS Dhoni', 'DJ Bravo']
  Resampled PURPLE [longest_serving]:
    was: ['WP Saha', 'RV Uthappa', 'MS Dhoni', 'DJ Bravo']
    now: ['R Ashwin', 'MK Pandey', 'RG Sharma', 'S Dhawan']
  Resampled PURPLE [longest_serving]:
    was: ['R Ashwin', 'MK Pandey', 'RG Sharma', 'S Dhawan']
    now: ['A Mishra', 'RA Jadeja', 'DJ Bravo', 'DS Kulkarni']
  Resampled PURPLE [longest_serving]:
    was: ['A Mishra', 'RA Jadeja', 'DJ Bravo', 'DS Kulkarni']
    now: ['V Kohli', 'S Dhawan', 'RV Uthappa', 'AB de Villiers']
  AMBIGUITY CHECK: PASS
...
Ed 43 — 2026-05-05
  yellow   [team_players:DC:2025] -> Delhi Capitals 2025 Squad: ['Abishek Porel', 'Mukesh Kumar', 'Jake Fraser-McGurk', 'Vipraj Nigam']
  green    [team_legends_batting:CSK] -> Chennai Super Kings Batting Legends: ['SR Watson', 'RA Jadeja', 'AT Rayudu', 'SV Samson']
  blue     [winning_squad:2011] -> 2011 Champions — Chennai Super Kings: ['M Vijay', 'DE Bollinger', 'S Badrinath', 'TG Southee']
  purple   [orange_cap] -> Orange Cap Winners: ['RV Uthappa', 'DA Warner', 'CH Gayle', 'Shubman Gill']
  Resampled PURPLE [orange_cap]:
    was: ['RV Uthappa', 'DA Warner', 'CH Gayle', 'Shubman Gill']
    now: ['JC Buttler', 'Shubman Gill', 'V Kohli', 'RV Uthappa']
  Resampled PURPLE [orange_cap]:
    was: ['JC Buttler', 'Shubman Gill', 'V Kohli', 'RV Uthappa']
    now: ['JC Buttler', 'Shubman Gill', 'V Kohli', 'CH Gayle']
  AMBIGUITY CHECK: PASS
  ...
  green    [team_legends_batting:CSK] -> Chennai Super Kings Batting Legends: ['SR Watson', 'RA Jadeja', 'AT Rayudu', 'SV Samson']
  blue     [winning_squad:2011] -> 2011 Champions — Chennai Super Kings: ['M Vijay', 'DE Bollinger', 'S Badrinath', 'TG Southee']
  purple   [orange_cap] -> Orange Cap Winners: ['JC Buttler', 'Shubman Gill', 'V Kohli', 'CH Gayle']
  Written -> C:\Users\Modern14\git\ipl_games\packages\puzzle-curator\..\..\apps\web\public\puzzles\ipl\2026-05-05.json
  

   Ed 44 � 2026-05-06
       yellow   [team_players:SRH:2025] -> Sunrisers Hyderabad 2025 Squad: ['Harsh Dubey', 'Ravichandran Smaran', 'Nitish
      Kumar Reddy', 'Kamindu Mendis']
       green    [team_legends_batting:PBKS] -> Punjab Kings Batting Legends: ['SS Iyer', 'CH Gayle', 'KD Karthik', 'DA
     Miller']
       blue     [state:Haryana] -> Players from Haryana: ['Joginder Sharma', 'A Chandila', 'NA Saini', 'A Mishra']
       purple   [winning_squad:2009] -> 2009 Champions � Deccan Chargers: ['HH Gibbs', 'DB Ravi Teja', 'VVS Laxman',
     'WPUJC Vaas']
       AMBIGUITY CHECK: PASS
